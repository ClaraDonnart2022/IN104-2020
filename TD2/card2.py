...
TODO:
  ...
  - le init qui prend 0 ou 2 parametres (indication: chercher sur
  StackOverflow "python optional arguments in initializer of python class")
  - coder points ; d'ailleurs, est-ce une fonction ou un attribut ?
  - corriger le bug: qui est que le 10 est plus fort que Dame Roi Valet (7 8 9
  V D R 10 As)
...
class Card:
    ...
    def points_carte(self):
        if ((self.valeur == Valeur.SEPT) or (self.valeur == Valeur.HUIT)
           or (self.valeur == Valeur.NEUF)):
            self.points = 0
...
def jouer():
    ...
    if p1 == p2:
        # Ce cas n'est pas censé se produire dans le cadre de la belotte
        print("Égalité")
    elif p1 > p2:
